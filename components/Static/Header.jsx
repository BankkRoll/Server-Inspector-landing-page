                ...
                <div className="relative w-full h-full">
                    <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                        <div className="flex items-center">
                            <Image
                                src="/img/logo_placeholder.jpg"
                                className="rounded-full icon-glow"
                                width={25}
                                height={25}
                                alt="logo"
                            />
                            <p className=" font-extrabold ml-1 text-lg">
...
const Header = ({ $, NavItems }) => {
    ...
    useEffect(() => {
        ...
        if (theme === 'red') setHue('hue-rotate-[0deg]');
        if (theme === 'yellow') setHue('hue-rotate-[60deg]');
        if (theme === 'cyan') setHue('hue-rotate-[180deg]');
    }, []);
