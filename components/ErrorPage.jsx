...
const ErrorPage = ({ message }) => {
    ...
    const PongGame = () => {
        ...
        useEffect(() => {
            ...
            const balls = [
                { x: canvas.width / 2, y: canvas.height / 2, dx: 2, dy: 2, radius: 10, color: themeColorMap[theme] || 'rgba(245, 158, 11)' },
                { x: canvas.width / 3, y: canvas.height / 3, dx: 1, dy: 1, radius: 10, color: themeColorMap[theme] || 'rgba(245, 158, 11)' },
                { x: canvas.width / 4, y: canvas.height / 4, dx: 3, dy: 3, radius: 10, color: themeColorMap[theme] || 'rgba(245, 158, 11)' },
            ];
