        ...
        <>
            <div className="py-20 mb-30 max-w-3xl mx-auto">
                ...
                <p className="animateHeader text-white text-opacity-50 text-center mt-5">
                    Server Inspectorᴮᴱᵀᴬ is here to monitor your server from
                    bots, links, and other security risks!
                </p>
                <div className="animateHeader mt-10 flex flex-col md:flex-row items-center justify-center gap-y-4 md:gap-x-4">
                    <Link href={'/commands'}>
                        <a
                            className={
                                'flex items-center justify-center min-w-[max-content] px-6 gap-x-2 shadow-lg shadow-amber-600/20 rounded-xl py-4 font-medium bg-gradient-to-bl from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white'
                            }
                        >
                            Command Simulator
                        </a>
                    ...
                    <Link
                        href={
                            'https://discord.com/api/oauth2/authorize?client_id=977774758647189506&permissions=8&scope=applications.commands%20bot'
                        }
                    >
                        <a
                            className={
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
                <div className="col-span-4 sm:w-full lg:w-auto mx-auto bg-gradient-to-br from-neutral-900/90 to-neutral-900/50 rounded-xl p-6 shadow-xl border border-amber-500/60 perspective-left hover:scale-100 transition-transform duration-800 shadow-black duration-800 ease-in-out">
                    ...
                    <p className="text-white text-md font-medium text-gray-500/75 mt-4">
                        Protect your server from bots, links, and other security
                        risks with Server Inspector.
                    </p>
                    <a
                ...
                <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <div className="text-white">
                            ...
                            <p className="text-gray-500 line-clamp-4">
                                Multi-step verification panel with buttons,
                                modals, and a in server 3 step panel. Contains
                                advanced DM reminder for protection & advanced
                                setup for bot defence.
                            </p>
                        </div>
                    </div>
                    <div>
                        <div className="text-white">
                            ...
                            <p className="text-gray-500 line-clamp-4">
                                Configure raid protection, user names to be
                                kicked, links to be blocked and many more! Set
                    ...
                    <div>
                        <div className="text-white">
                            <p className="text-xl font-semibold mt-5">
                                <i
                                    className={`fa fa-clock text-2xl text-amber-500`}
                                />{' '}
                                99.9% Uptime
                            </p>
                            <p className="text-gray-500 line-clamp-4">
                                Bot is developed by 1 single dev, with secure
                                hosting platform. If there is any downtime it is
                                likely for updates or new features! Sorry in
                                advance.
                            </p>
                        </div>
                    </div>
                    <div>
                        <div className="text-white">
                            <p className="text-xl font-semibold mt-5">
                                <i
                                    className={`fa fa-lock text-2xl text-amber-500`}
                                />{' '}
                                SECURITY
                            </p>
                            <p className="text-gray-500 line-clamp-4">
                                Bot token is occasionally reset on updates. Bot
                                code is only owned by one person and never
                                shared.
                            </p>
                        </div>
                    </div>
            ...
            <div
                className={`flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md border border-amber-500/60`}
            >
                <>
                    <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                        ...
                        <p className="text-md font-medium text-gray-500 line-clamp-5">
                            Are you ready to enhance your server security with
                            Server Inspector?
                        </p>
                    </div>
                    <img
                        src="/img/panel.gif"
                        className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black hover:scale-100 transition-transform duration-800 ease-in-out"
                        alt="panel"
                    />
                </>
            </div>
            ...
            {botStats && (
                <div
                    className={`mt-16 p-6 text-center border border-amber-500/60 text-white rounded-lg`}
                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div className="flex flex-col items-center py-4 px-6 bg-gradient-to-br from-neutral-900/90 to-neutral-900/50 rounded-lg shadow-md perspective-left hover:scale-100 transition-transform duration-800 ease-in-out">
                            ...
                            <p className="text-lg">
                                {botStats['User count'].toLocaleString()} users
                            </p>
                        </div>
                        <div className="flex flex-col items-center py-4 px-6 bg-gradient-to-br from-neutral-900/90 to-neutral-900/50 rounded-lg shadow-md perspective-left hover:scale-100 transition-transform duration-800 ease-in-out">
                            <h3 className="text-xl font-semibold mb-2">
                            ...
                            <p className="text-lg">
                                {botStats['Spammers kicked'].toLocaleString()}{' '}
                                spammers
                            </p>
                        </div>
                        <div className="flex flex-col items-center py-4 px-6 bg-gradient-to-br from-neutral-900/90 to-neutral-900/50 rounded-lg shadow-md perspective-left hover:scale-100 transition-transform duration-800 ease-in-out">
                            ...
                            <p className="text-lg">
                                {botStats['Links blocked'].toLocaleString()}{' '}
                                links
                            </p>
                        </div>
                    </div>
